...
class Runner(object):
    ...
    @torch.no_grad()
    def i2sb_sampling(self, opt, x1, mask=None, cond=None, clip_denoise=False, nfe=None, log_count=10, verbose=True):
        ...
        with self.ema.average_parameters():
            ...
            xs, pred_x0 = self.diffusion.i2sb_sampling(
    ...
    @torch.no_grad()
    def i3sb_sampling(self, opt, x1, ita=0, mask=None, cond=None, clip_denoise=False, nfe=None, log_count=10, verbose=True):
        ...
        with self.ema.average_parameters():
            ...
            xs, pred_x0 = self.diffusion.i3sb_sampling(
                steps, pred_x0_fn, x1, ita=ita, mask=mask, ot_ode=opt.ot_ode, log_steps=log_steps, verbose=verbose,
            )
